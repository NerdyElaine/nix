...
#s(hash-table test equal data ("straight" ("2026-04-26 14:50:24" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "main" :package "straight" :local-repo "straight.el")) "org-elpa" ("2026-04-26 14:50:24" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2026-04-26 14:50:32" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2026-04-26 14:50:34" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "use-package" ("2026-04-26 14:50:38" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2026-04-26 14:50:38" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "nongnu-elpa" ("2026-04-26 14:50:41" nil (:type git :repo "https://github.com/emacsmirror/nongnu_elpa.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2026-04-26 14:50:44" nil (:type git :host github :repo "dimitri/el-get" :build nil :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2026-04-26 14:50:46" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "base16-theme" ("2026-04-26 15:00:46" nil (:type git :files (:defaults "build/*.el" "base16-theme-pkg.el") :host github :repo "tinted-theming/base16-emacs" :package "base16-theme" :local-repo "base16-emacs")) "everforest" ("2026-04-26 15:06:20" ("emacs") (:type git :host github :repo "Theory-of-Everything/everforest-emacs" :package "everforest" :local-repo "everforest-emacs"))))
